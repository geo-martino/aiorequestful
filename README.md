...
> [!NOTE]
> For more info on payload handling, [read the docs](https://geo-martino.github.io/aiorequestful/guides/response.html#payload).
...
> [!NOTE]
> For more info on authorising including other types of supported authorisation flows, [read the docs](https://geo-martino.github.io/aiorequestful/guides/auth.html#auth).
...
> [!NOTE]
> For more info on setting a successful cache and other supported cache backends, [read the docs](https://geo-martino.github.io/aiorequestful/guides/cache.html#cache).
...
> [!NOTE]
> For more info on `StatusHandler` and how they handle each response type, [read the docs](https://geo-martino.github.io/aiorequestful/guides/response.html#status).
...
> [!NOTE]
> For more info on the available `Timer` objects, [read the docs](https://geo-martino.github.io/aiorequestful/guides/timer.html#timer).
