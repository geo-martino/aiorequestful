...
from collections.abc import Awaitable, MutableMapping, Callable, Coroutine, Generator
...
from aiorequestful.types import Headers, ImmutableJSON, JSON, MutableJSON, MethodInput, URLInput, Method, \
    ImmutableHeaders
...
class AuthResponseHandler:
    ...
    def save_response_to_file(self, response: MutableJSON = None) -> None:
        ...
        """
        response = response or self.response
        if not self.file_path or not response:
            return
